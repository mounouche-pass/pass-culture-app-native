export interface MockServerInterface<BodyType, HeadersType, RequestBody> {
  ...
  mode: MockServerMode
  delay: number
  get<TResponse extends BodyType>(url: string, options: TResponse): MockReturnType
  get<TResponse extends BodyType>(
    url: string,
    options: MockOptions<HeadersType, TResponse, RequestBody>
  ): MockReturnType
  post<TResponse extends BodyType>(url: string, options: TResponse): MockReturnType
  post<TResponse extends BodyType>(
    url: string,
    options: MockOptions<HeadersType, TResponse, RequestBody>
  ): MockReturnType
  delete<TResponse extends BodyType>(url: string, options: TResponse): MockReturnType
  delete<TResponse extends BodyType>(
    url: string,
    options: MockOptions<HeadersType, TResponse, RequestBody>
  ): MockReturnType
  put<TResponse extends BodyType>(url: string, options: TResponse): MockReturnType
  put<TResponse extends BodyType>(
    url: string,
    options: MockOptions<HeadersType, TResponse, RequestBody>
  ): MockReturnType
}
